...
export class UserConfig {
  ...
  pharmacistConfig: OpenIdConfiguration = {
    ...
    post_logout_redirect_uri: 'http://app.qtlife.com:4200/loggedout/pharmacist',
  ...
  cardiologistConfig: OpenIdConfiguration = {
    ...
    post_logout_redirect_uri: 'http://app.qtlife.com:4200/loggedout/cardiologist',
  ...
  centerGroupConfig: OpenIdConfiguration = {
    ...
    post_logout_redirect_uri: 'http://app.qtlife.com:4200/loggedout/center',
  ...
  nambayauserConfig: OpenIdConfiguration = {
    ...
    response_type: 'id_token token', // 'id_token token' Implicit Flow
    scope:
      'logging_api openid profile email pharmacy_api central_group_api cardiologist_api nambaya_user_api offline_access User',
    post_logout_redirect_uri: 'http://app.qtlife.com:4200/loggedout/user',

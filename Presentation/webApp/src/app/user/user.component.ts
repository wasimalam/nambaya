...
export class UserComponent implements OnInit {
  ...
  constructor(
    ...
    const userDataInterval = setInterval(() => {
      if (this.oauthService.userData.rolecode) {
        this.roleCode = this.oauthService.userData.rolecode;
  ...
  ngOnInit() {
    ...
    const caseDispatchedReq = this.userService.getCaseDispatchedStats();
    const goalsCompletedReq = this.userService.getGoalsCompleted();
    const monthlyCaseStartedReq = this.userService.getMonthlyCaseStarted();
    const monthlyCaseCompletedReq = this.userService.getMonthlyCaseCompleted();
    const cardiologistNoteStatsReq = this.userService.getCardiologistNoteStats();
    const qeStatusReq = this.userService.getQEStatusStats();
  ...
  private getStats() {
    this.userService.getuserDashboardStats().subscribe(result => {
      this.userStatsData = result;
    });
  }

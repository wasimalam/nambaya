...
export class UserConfig{
    ...
    pharmacistConfig: OpenIdConfiguration = {
        ...
        post_logout_redirect_uri: 'https://www.nambaya-medical.de/loggedout/pharmacist',
      ...
      cardiologistConfig: OpenIdConfiguration = {
        ...
        post_logout_redirect_uri: 'https://www.nambaya-medical.de/loggedout/cardiologist',
      ...
      centerGroupConfig: OpenIdConfiguration = {
        ...
        post_logout_redirect_uri: 'https://www.nambaya-medical.de/loggedout/center',
      ...
      nambayauserConfig: OpenIdConfiguration = {
        ...
        post_logout_redirect_uri: 'https://www.nambaya-medical.de/loggedout/user',

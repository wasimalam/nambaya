...
export class Addresses {
  ...
  physicanRedirectUrl: string = 'http://pharmacist.qtlife.com:4200/center/dashboard';
  centerGroupRedirectUrl: string = 'http://pharmacist.qtlife.com:4200/center/dashboard';
  nambayaUserRedirectUrl: string = 'http://pharmacist.qtlife.com:4200/user/dashboard';
  cardiologistRedirectUrl: string = 'http://pharmacist.qtlife.com:4200/cardiologist/dashboard';
  pharmacistRedirectUrl: string = 'http://pharmacist.qtlife.com:4200/pharmacist/patients';
  logoutUrl: string = 'http://pharmacist.qtlife.com:4200/logout';
  postLogoutRedirectUri: 'http://pharmacist.qtlife.com:4200/logout';
}

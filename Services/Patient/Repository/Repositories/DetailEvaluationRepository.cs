...
{
    public class DetailEvaluationRepository : DapperRepositoryBase<DetailEvaluation>, IDetailEvaluationRepository
    {
        public DetailEvaluationRepository(IDatabaseSession session) : base(session)
        {

        }
        public IEnumerable<DetailEvaluation> GetByPatientCaseId(long patientcaseid)
        {

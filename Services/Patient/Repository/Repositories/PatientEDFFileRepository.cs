...
{
    public class PatientEDFFileRepository : DapperRepositoryBase<PatientEDFFile>, IPatientEDFFileRepository
    {
        public PatientEDFFileRepository(IDatabaseSession session) : base(session)
        {

        }
        public IEnumerable<PatientEDFFile> GetByPatientCaseId(long patientcaseid)
        {

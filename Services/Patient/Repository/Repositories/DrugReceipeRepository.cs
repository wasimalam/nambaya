...
{
    public class DrugReceipeRepository : DapperRepositoryBase<DrugReceipe>, IDrugReceipeRepository
    {
        public DrugReceipeRepository(IDatabaseSession session) : base(session)
        {

        }
        public IEnumerable<DrugReceipe> GetByDrugGroupId(long druggroupid)
        {

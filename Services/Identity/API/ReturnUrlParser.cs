...
namespace Identity.API
{
    public class ReturnUrlParser : IReturnUrlParser
    {
        ...
        public ReturnUrlParser(
            ...
            WebServiceConfiguration webApiConf,
        ...
        public bool IsValidReturnUrl(string returnUrl)
        {
            ...
            _logger.LogDebug($"\n*********_webApiConf.IdentityServerBaseUrl {_webApiConf.IdentityServerBaseUrl.DNS()}, Issuer :{_configuration["Issuer"].DNS()}****\n");

            if (returnUrl.IsLocalUrl() || returnUrl.DNS().ToLower() == _webApiConf.IdentityServerBaseUrl.DNS().ToLower()
                || (returnUrl.DNS().ToLower() == _configuration["Issuer"].DNS().ToLower()))
            {
            ...
            _logger.LogDebug($"*******returnUrl {returnUrl} is not valid******");
            return false;
        }
    }
    ...
    internal static class Extensions
    {
        ...
        public static string DNS(this string url)
        {
            if (url != null)
            {
                Uri uri = new Uri(url);
